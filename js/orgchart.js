...
(OrgChart._defaultConfig = function (t) {
  ...
  (OrgChart.prototype._draw = function (t, e, r, i) {
    ...
    if (this.isVisible) {
      ...
      var o = e == OrgChart.action.init ? null : this.getViewBox();
      this.manager.read(
        t,
        this.width(),
        this.height(),
        ...
        function (t) {
          if (!a.notifierUI.show(t.notif)) {
            ...
            var n = a.ui.defs(o.defs),
              l = a.getScale(t.viewBox);
            n += a.ui.pointer(a.config, e, l);
            var s = a.getViewBox(),
              h = t.viewBox;
            o = { content: n, res: t };
            OrgChart.events.publish("prerender", [a, o]), (n = o.content);
            ...
            for (c = 0; c < t.visibleNodeIds.length; c++) {
              ...
              OrgChart.RENDER_LINKS_BEFORE_NODES ||
                ...
                (n += a.ui.expandCollapseBtn(a, d, a._layoutConfigs, e, l));
            }
            o = { content: n, res: t };
            if (
              ...
              (e !== OrgChart.action.centerNode &&
                ...
                (a.response = t);
              v = a.ui.svg(a.width(), a.height(), h, a.config, n);
              if (a._initialized) {
                var p = a.getSvg(),
                  u = p.parentNode;
                u.removeChild(p),
              ...
              e === OrgChart.action.centerNode
                ...
                a._initialized ||
                  ((a._initialized = !0), OrgChart.events.publish("init", [a]));
            } else {
              var C = t.boundary,
                b = C.maxX - C.minX,
                O = C.maxY - C.minY,
                v = a.ui.svg(b, O, [C.minX, C.minY, b, O], a.config, n, l);
              i(v);
            }
          }
        },
  ...
  (OrgChart.prototype._showAfterAnimation = function () {
    ...
    for (e = 0; e < o.length; e++) o[e].style.display = "";
    this._hideBeforeAnimationCompleted = !1;
  }),
  ...
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.anim = function (t, e, r, i, a, o, n) {
    var l,
      s = 10,
      h = 1,
      c = i / s + 1;
    ...
    return (
      ...
      (l = setInterval(function () {
        for (var d = 0; d < t.length; d++)
          for (var g in r[d]) {
            ...
            switch (g.toLowerCase()) {
              case "d":
                var u =
                    a((h * s - s) / i) * (r[d][g][0] - e[d][g][0]) + e[d][g][0],
                  f =
                    a((h * s - s) / i) * (r[d][g][1] - e[d][g][1]) + e[d][g][1];
                t[d].setAttribute(
                  "d",
              ...
              case "transform":
                if (r[d][g]) {
                  ...
                  t[d].hasAttribute("transform")
                    ...
                    : (t[d].style.transform = "matrix(" + O.toString() + ")");
                }
                break;
              case "viewbox":
                if (r[d][g]) {
        ...
        n && n(), (h += 1) > c + 1 && (clearInterval(l), o && o(t));
      }, s))
    );
  }),
    ...
    this.obj.element.appendChild(a.element),
      ...
      this.obj.element
        ...
        .addEventListener("click", function (e) {
          ...
          if (!1 !== r) {
            var o = i.obj.get(t),
              n = OrgChart.mergeDeep(o, r);
            i.obj.updateNode(n, null, !0), i.hide();
          }
        });
    for (
      var o = this.obj.element.querySelectorAll("[boc-input-btn]"), n = 0;
      n < o.length;
      n++
    ) {
      o[n].addEventListener("click", function (e) {
        OrgChart.events.publish("element-btn-click", [
          i,
          { input: this.parentNode.querySelector("input"), nodeId: t },
        ]);
      });
    }
    this.obj.element
      ...
      this.obj.element
        ...
        .addEventListener("click", function (e) {
          for (
            ...
            r = r.parentNode;
          if (r && r.hasAttribute) {
            var o = r.getAttribute("data-edit-from-btn"),
              n = {
                button: i.obj.config.editForm.buttons[o],
                name: o,
                nodeId: t,
                event: e,
              };
            if (!1 === OrgChart.events.publish("button-click", [i, n]))
              return !1;
            switch (o) {
              case "edit":
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
    var o,
      n = this.obj.config.editForm.readOnly,
      ...
      d = this.obj.config.editForm.photoBinding,
    ...
    if (this.obj.config.editForm.generateElementsFromFields)
      for (var C = 0; C < this.fields.length; C++) {
        ...
        if ("tags" != b) {
          ...
          O || l.push({ type: "textbox", label: b, binding: b });
        }
      }
    OrgChart.isNEU(f) && (f = ""),
      (m = OrgChart.isNEU(m)
        ? OrgChart.icon.user(150, 150, "#8C8C8C", 0, 0)
        : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${m}"></img>`);
    var y = !e,
      w = e ? "display:none;" : "",
      _ = e || !s ? "display:none;" : "",
      k = u.editFormHeaderColor
        ? `style="background-color:${u.editFormHeaderColor};"`
        : "",
      S = document.createElement("form");
    if (
      (S.setAttribute("data-boc-edit-form", ""),
    ...
    return (
      (S.innerHTML = `<div>\n                        <div class="boc-edit-form-header" ${k}>\n                            ${A}\n                            <h1 class="boc-edit-form-title">${f}</h1>\n                            <div id="boc-avatar" class="boc-edit-form-avatar">${m}</div>                        \n                        </div>\n                        <div data-boc-edit-from-btns class="boc-edit-form-instruments">\n                        ${(function () {
        ...
        for (var r in h) {
          ...
          OrgChart.isNEU(i) ||
            ...
            (n && "Edit" == i.text) ||
            (t += `<div data-edit-from-btn='${r}' class="boc-img-button" ${k} title="${i.text}">${i.icon}</div>`);
        }
        return t;
        ...
        for (var t = "", r = 0; r < l.length; r++) {
          ...
          if (Array.isArray(i)) {
            ...
            for (var a = 0; a < i.length; a++) {
              var n = i[a],
                s = OrgChart.elements[n.type](p, n, "unset", e);
              !OrgChart.isNEU(s.id) &&
                OrgChart.isNEU(o) &&
                OrgChart.isNEU(s.value) &&
                (o = s.id),
                OrgChart.isNEU(s.value) || I.push(`${n.label}: ${s.value}`),
                (t += s.html);
            }
            t += "</div>";
          } else {
      ...
      { element: S, focusId: o, title: f, shareText: I.join("\n") }
    );
  }),
    ...
    if ("" != n) {
      ...
      for (
        ...
        (s = u[f]).addEventListener("click", function (t) {
          var e,
            n = this.getAttribute(OrgChart.attr.item);
          if (void 0 === a[n].onClick)
            if ("add" === n) {
              var l = { id: o.obj.generateId(), pid: r };
              o.obj.addNode(l, null, !0);
            } else if ("edit" === n) {
              var s = o.obj.getNode(r);
              o.obj.editUI.show(s.id);
            } else if ("details" === n) {
              s = o.obj.getNode(r);
              o.obj.editUI.show(s.id, !0);
            } else
              "remove" === n
                ? o.obj.removeNode(r, null, !0)
                : "svg" === n
                ? o.obj.exportSVG({
                ...
                : "csv" === n
                ? o.obj.exportCSV()
                : "xml" === n && o.obj.exportXML();
          else e = a[n].onClick.call(o.obj, r, i);
          0 != e && o.hide();
        });
      }
    }
  ...
  (OrgChart.circleMenuUI.prototype.hide = function () {
    ...
    if (null != e) {
      ...
      o[0].setAttribute("x1", -a.nodeCircleMenuButton.radius / 2),
        o[0].setAttribute("x2", a.nodeCircleMenuButton.radius / 2),
        o[0].setAttribute("y1", -6),
        o[0].setAttribute("y2", -6),
        o[1].setAttribute("x1", -a.nodeCircleMenuButton.radius / 2),
        o[1].setAttribute("x2", a.nodeCircleMenuButton.radius / 2),
        o[1].setAttribute("y1", 0),
        o[1].setAttribute("y2", 0),
        o[2].setAttribute("x1", -a.nodeCircleMenuButton.radius / 2),
        o[2].setAttribute("x2", a.nodeCircleMenuButton.radius / 2),
        o[2].setAttribute("y1", 6),
        o[2].setAttribute("y2", 6),
  ...
  (OrgChart.toolbarUI.prototype.init = function (t, e) {
    if (e) {
      ...
      var r = this.div.querySelector("[" + OrgChart.attr.tlbr + '="plus"]'),
        ...
        o = this.div.querySelector("[" + OrgChart.attr.tlbr + '="fullScreen"]'),
        n = this.div.querySelector("[" + OrgChart.attr.tlbr + '="expand"]'),
        l = this;
      r &&
      ...
      this._draw(!1, OrgChart.action.exporting, i, function (i) {
        ...
        if (((a.innerHTML = i), t.padding > 0)) {
          var o = a.querySelector("svg"),
            n = OrgChart._getViewBox(o);
          (n[0] -= t.padding),
            (n[1] -= t.padding),
            (n[2] += 2 * t.padding),
            (n[3] += 2 * t.padding),
            o.setAttribute("viewBox", n.join()),
            o.setAttribute("width", n[2]),
            o.setAttribute("height", n[3]);
        }
        if ("svg" == t.ext)
          if (e) e(t, a.innerHTML);
          else {
            (o = a.querySelector("svg")).classList.add("boc-" + r.config.mode);
          ...
          r._pages(t, a.querySelector("svg"), function (i) {
            var o = { content: a.innerHTML, options: t, pages: i, styles: "" },
              n = OrgChart.events.publish("exportstart", [r, o]),
              l = r.element.querySelector("[data-boc-styles]");
            if ((l && (o.styles += l.outerHTML), !1 === n)) return !1;
            e || OrgChart.loading.show(r),
              e
                ? e(r, o, a.querySelector("svg"))
                : ((o = JSON.stringify(o)),
                  OrgChart._ajax(
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    switch (t.format) {
      ...
      case "A1":
        ...
        break;
      case "Letter":
        (a = OrgChart.Letterw), (o = OrgChart.Letterh);
        break;
      case "Legal":
        (a = OrgChart.Legalw), (o = OrgChart.Legalh);
    }
    var n = i[0],
      l = i[1],
      s = i[2],
      ...
      publish: function (e, r) {
        if (t[e]) {
          for (var i = [], a = 0; a < t[e].length; a++) {
            var o = t[e][a];
            (null != o.event_id && o.event_id != r[0]._event_id) ||
              i.push(o.listener);
          }
          if (i.length > 0) {
            var n = !0;
            for (a = 0; a < i.length; a++)
              1 == r.length
                ...
                ? (n = i[a](r[0], r[1], r[2]) && n)
                : 4 == r.length
                ? (n = i[a](r[0], r[1], r[2], r[3]) && n)
                : 5 == r.length &&
                  (n = i[a](r[0], r[1], r[2], r[3], r[4]) && n);
            return n;
          }
        }
      },
      ...
      (e.onchange = function (e) {
        ...
        (i.onload = function () {
          var e = i.result,
            ...
            a = [],
            o = r[0];
          OrgChart._importSetColumnNames(o, function (e) {
            for (var i = 1; i < r.length; i++) {
              for (var o = {}, n = 0; n < r[i].length; n++) {
                var l = e[n],
                  s = r[i][n];
  ...
  (OrgChart._importSetColumnNames = function (t, e) {
    if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
      ...
      a.setAttribute("id", "boc-sampleDialog"),
        ...
        (l.style.top = "2px"),
        (l.style.zIndex = 100),
        n.setAttribute("id", "content"),
        (n.style.padding = "2px"),
        (o.innerHTML = "Import Organizational Chart Data"),
        (l.innerHTML = "&times;");
      ...
      (v.innerHTML = "Import"),
        ...
        (v.onclick = function () {
          ...
          var r = g.options[g.selectedIndex].value,
            i = t.indexOf(r);
          t[i] = "id";
          var o = b.options[b.selectedIndex].value,
            n = t.indexOf(o);
          (t[n] = "pid"), e(t);
        });
  ...
  (OrgChart.prototype.maximize = function (t, e, r, i) {
    var a = this,
      o = { id: t, options: {} };
    OrgChart.isNEU(o.id) && ((o.id = this.roots[0].id), (o.all = !0)),
      (o.options.horizontal = !1),
      (o.options.vertical = !1),
      e && (o.options.horizontal = e),
      r && (o.options.vertical = r),
      this._draw(!1, OrgChart.action.maximize, o, function () {
        a.ripple(t), i && i();
      });
  }),
    ...
    if (
      ...
      if (e.changedTouches.length) {
        var r = {
          ...
          a = this.getScale(),
          o = Math.abs(r.x - this._touch.x) / a,
          n = Math.abs(r.y - this._touch.y) / a;
        if (((this._touch = null), o > i[0] / 10)) return;
        if (n > i[1] / 10) return;
      }
  ...
  (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (
    ...
    var i = t.parentNode.getAttribute(
      ...
      o = this.nodeCircleMenuUI._menu[a];
    if (o.draggable) {
      var n = this,
      ...
      var O = function (t, e) {
          if (null != t) {
            ...
            for (
              var r = OrgChart.getStParentNodes(n.getNode(c)), i = 0;
              i < r.length;
              i++
            ) {
              var a = n.getNodeElement(r[i].id);
              a && (a.style.opacity = 1);
            }
          }
        },
        v = function (e) {
          if (p) {
            ...
            OrgChart.isMobile() && (i = document.elementFromPoint(r.x, r.y)),
              (r.x += b.x * h),
              (r.y += b.y * h);
            var l = OrgChart._getOffsetXY(n.element, e),
              s = {
                left: n.width() - (l.x + n.config.padding) < 0,
                right: l.x - n.config.padding < 0,
                down: n.height() - (l.y + n.config.padding) < 0,
                up: l.y - n.config.padding < 0,
              };
            if (s.left || s.right || s.up || s.down) {
              ...
              var v = f[4],
                ...
                k = r.x,
                S = r.y;
              n.startMove(s, function (t) {
                (f[4] = v + t.x),
                  (f[5] = y + t.y),
                  (p.x = w - t.xWithoutScale),
                  (p.y = _ - t.yWithoutScale),
              ...
              if (null != c) {
                ...
                for (
                  var A = n.getNode(c), L = OrgChart.getStParentNodes(A), N = 0;
                  N < L.length;
                  N++
                ) {
                  var M = n.getNodeElement(L[N].id);
              ...
              if (
                ...
                !1 ===
                  OrgChart.events.publish("drag", [
                    n.nodeCircleMenuUI,
                    { from: I, menuItem: o, menuItemName: a },
                  ]) && x(),
                  (t._dragEventFired = !0);
              u.setAttribute("transform", "matrix(" + f.toString() + ")");
            }
        ...
        x = function (e) {
          if (
            ...
            return (
              g.removeChild(u),
              (n._gragStartedId = null),
              void (
                t._dragEventFired &&
                OrgChart.events.publish("drop", [
                  n.nodeCircleMenuUI,
                  { from: s.id, menuItemName: a, menuItem: o },
                ])
              )
            );
          var i = n.getNode(c);
          OrgChart.events.publish("drop", [
            n.nodeCircleMenuUI,
            { from: s.id, to: i.id, menuItem: o, menuItemName: a },
          ]),
            O(c, d),
            g.removeChild(u),
            (n._gragStartedId = null);
    ...
    if (this.config.enableDragDrop) {
      ...
      var m = function (t, e) {
          if (null != t) {
            e.classList.remove("boc-drag-over");
            for (
              var r = s.getNode(n), i = OrgChart.getStParentNodes(r), a = 0;
              a < i.length;
              a++
            ) {
              var o = s.getNodeElement(i[a].id);
              o && (o.style.opacity = 1);
            }
          }
        },
            ...
            if (C.left || C.right || C.up || C.down) {
              ...
              s.startMove(C, function (t) {
                (d[4] = O + t.x),
                  ...
                  (r.x = w - t.xWithoutScale),
                  (r.y = _ - t.yWithoutScale),
              ...
              if (null != n) {
                ...
                for (
                  var S = s.getNode(n), I = OrgChart.getStParentNodes(S), A = 0;
                  A < I.length;
                  A++
                ) {
                ...
                !s._canUpdateLink(o.id, n) && h.classList
                  ? (h.classList.remove("boc-cursor-grab"),
                    h.classList.remove("boc-cursor-move"),
                    h.classList.remove("boc-cursor-copy"),
        ...
        b = function (e) {
          if (
            ...
            return (
              ...
              void (
                t._dragEventFired && OrgChart.events.publish("drop", [s, o.id])
              )
            );
          var i = s.getNode(n);
          if (!1 === OrgChart.events.publish("drop", [s, o.id, i.id]))
            return m(n, l), h.removeChild(f), void (s._gragStartedId = null);
          if (s._canUpdateLink(o.id, n)) {
            var a = s.get(o.id);
            (a.pid = n), (a.stpid = null), s.updateNode(a, null, !0);
          } else h.removeChild(f), m(n, l);
          s._gragStartedId = null;
        };
  ...
  (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    var a = this.getViewBox(),
      o = this.getScale(),
      n = OrgChart._getClientTouchesXY(e, 0),
    ...
    e.touches &&
      ...
      ((s.type = "pinch"),
      (s.dist = Math.sqrt(
        (n.x - l.x) * (n.x - l.x) + (n.y - l.y) * (n.y - l.y)
      )));
    ...
    if ("pan" == s.type) {
      ...
      (h.style.display = "inherit"),
        ...
        OrgChart.anim(
          ...
          { transform: [1 / o, 0, 0, 1 / o, d, g], opacity: 1 },
          300,
          OrgChart.anim.outBack
        );
    }
    var p = function (t) {
        ...
        if (s && "pan" == s.type) {
          i._hideBeforeAnimation(),
            (s.diffX = e.x - s.x0),
            (s.diffY = e.y - s.y0);
          var r = -s.diffY / o + s.viewBoxTop,
            n = -s.diffX / o + s.viewBoxLeft;
          i._move(r, n, a);
      ...
      a = `<table border="0" cellspacing="0" cellpadding="0">\n                    <tbody>\n                        ${(function () {
        for (
          ...
          var o = r[a],
            n = "";
          if (i) {
            var l = e.obj._get(o.id);
            "function" == typeof i
              ? (n = i(e.obj, e.obj.getNode(o.id), l))
              : l[i] && (n = l[i]);
          }
          var s = "",
            h = "";
          e.obj.config.searchDisplayField == o.__searchField
            ? (s = o.__searchMarks)
            : e.obj.config.searchDisplayField
            ? ((s = o[e.obj.config.searchDisplayField]),
              OrgChart.isNEU(s) && (s = ""),
              (h = o.__searchMarks))
            : (s = o.__searchMarks),
            (t += OrgChart.searchUI.createItem(n, o.id, s, h));
        }
        return t;
      })()}  \n                    </tbody>\n                </table>`;
    this.searchTableWrapper.innerHTML = a;
    for (
      var o = this.obj.element.querySelectorAll("[data-search-item-id]"), n = 0;
      n < o.length;
      n++
    )
  ...
  (OrgChart.manager.prototype.read = function (t, e, r, i, a, o, n, l) {
    var s = this;
  ...
  (OrgChart.manager.prototype._read = function (t, e) {
    var r = this,
      i = OrgChart.manager._createNodes(
        r.config,
        r.layoutConfigs,
        r.action,
        r.actionParams,
    ...
    var a = i.nodes,
      o = i.roots,
      n = OrgChart.remote;
    null == n && (n = OrgChart.local),
      n._setPositions(
        o,
        r.layoutConfigs,
        function (e) {
          var n = OrgChart.manager._doNotChangePositionOfClickedNodeIfAny(
            o,
            a,
            r.action,
            r.actionParams,
  ...
  (OrgChart.manager._setCollpasedProperty = function (t, e, r, i, a, o, n) {
    null == t.collapsed && e.collapse && e.collapse.allChildren
      ...
      a == OrgChart.action.init && null != n
        ? (t.collapsed = !n.exp.has(t.id))
        : a == OrgChart.action.init
        ? (t.collapsed =
            e.collapse && o >= e.collapse.level - 1 && -1 == i.indexOf(t.id))
  ...
  (OrgChart.manager._initNode = function (t, e, r, i, a, o, n, l, s, h, c) {
    var d = o[r || "base"];
    null == t.parent &&
      OrgChart.manager._setCollpasedProperty(t, d, s, l, a, i - 1, c);
    for (var g = 0; g < t.childrenIds.length; g++) {
      var p = e[t.childrenIds[g]];
      if (
        (OrgChart.manager._setCollpasedProperty(p, d, s, l, a, i, c),
        !p.collapsed)
      ) {
    ...
    if (
      (t.min ||
        a != OrgChart.action.minimize ||
        ((s.all || s.id == t.id) && (t.min = !0)),
      !0 === t.min &&
    ...
    (t.w = f && f.size ? f.size[0] : 0),
      ...
      null != i && (t.level = i),
      r && (t.lcn = r);
    var m = OrgChart._getSubLevels(t.tags, n.tags);
    m > 0 && (t.subLevels = m),
  ...
  (OrgChart.manager._iterate = function (
    t,
    e,
    r,
    i,
    ...
    if (
      (OrgChart.manager._initNode(e, r, s, i, d, h, c, g, p, u, f),
      e.isAssistant && (o[e.pid] || (o[e.pid] = []), o[e.pid].push(e.id)),
      e.subLevels > 0 && n.push(e.id),
      ...
      if (
        ...
        for (
          var m = [], C = 0, b = 0, O = 0;
          O < e.parent.children.length;
          O++
        ) {
          -1 == (v = e.parent.children[O]).tags.indexOf("partner") &&
        ...
        ((OrgChart.MIXED_LAYOUT_ALL_NODES &&
          m.length > 1 &&
          m.length == e.parent.children.length - C - b) ||
          (!OrgChart.MIXED_LAYOUT_ALL_NODES && m.length > 1)) &&
          (l[e.pid] = m);
      }
    } else if (
      !e.isAssistant &&
      ...
      for (m = [], C = 0, b = 0, O = 0; O < e.parent.children.length; O++) {
        var v;
        -1 == (v = e.parent.children[O]).tags.indexOf("partner") &&
        -1 == v.tags.indexOf("left-partner") &&
        -1 == v.tags.indexOf("right-partner") &&
      ...
      ((OrgChart.MIXED_LAYOUT_ALL_NODES &&
        m.length > 1 &&
        m.length == e.parent.childrenIds.length - C - b) ||
        (!OrgChart.MIXED_LAYOUT_ALL_NODES && m.length > 1)) &&
        (l[e.pid] = m);
    }
    e.stChildren.length &&
  ...
  (OrgChart.manager.__createNodes = function (t, e, r, i, a, o, n) {
    for (var l = r.nodes, s = [], h = 0; h < l.length; h++) {
      ...
      OrgChart.isNEU(d.ppid) || (p.ppid = d.ppid),
        ...
        null != r.orderBy &&
          (p.order = OrgChart.manager._getOrderFieldValue(d, r.orderBy)),
        (t[d.id] = p),
        s.push(d.id);
    }
    null != r.orderBy &&
      s.sort(function (e, i) {
        var a = t[e].order,
          o = t[i].order;
        return "number" == typeof a || "number" == typeof o
          ? (null == a && (a = -1),
            null == o && (o = -1),
            r.orderBy.desc ? o - a : a - o)
          : "string" == typeof a || "string" == typeof o
          ? (null == a && (a = ""),
            null == o && (o = ""),
            r.orderBy.desc ? o.localeCompare(a) : a.localeCompare(o))
          : void 0;
      });
    for (h = 0; h < s.length; h++) {
      ...
      if ((m || (p.stpid = null), C || (p.pid = null), m)) {
        var b = o ? o[m.id] : null;
        b && (m.min = b.min), m.stChildrenIds.push(p.id);
      } else
        C
          ? (f && ((p.collapsed = f.collapsed), (p.min = f.min)),
            C.childrenIds.push(p.id))
          : (f && ((p.collapsed = f.collapsed), (p.min = f.min)),
            e.push(p),
            n.push(p.id));
  ...
  (OrgChart.manager._createNodes = function (t, e, r, i, a, o) {
    var n = {},
      l = [],
      s = [];
    if (
      (OrgChart.manager.__createNodes(n, l, t, r, i, a, s), null != t.roots)
    ) {
      l = [];
      for (var h = 0; h < t.roots.length; h++) {
        ...
        if (c && r == OrgChart.action.centerNode) {
          for (var d = c; null != d.pid || null != d.stpid; )
            d = null == d.pid && null != d.stpid ? n[d.stpid] : n[d.pid];
          for (var g = n[i.id]; null != g.pid || null != g.stpid; )
            g = null == g.pid && null != g.stpid ? n[g.stpid] : n[g.pid];
          d == g && (c = d);
        }
        if (c) {
          ...
          if (!p) {
            if (!OrgChart.isNEU(c.pid))
              (z = (b = n[c.pid]).childrenIds.indexOf(c.id)) > -1 &&
                b.childrenIds.splice(z, 1);
            l.push(c);
          }
        }
      }
    ...
    r == OrgChart.action.exporting &&
      ...
      ((m.pid = null), (l = [m]));
    var f = [];
    if (r == OrgChart.action.init && t.expand && t.expand.nodes && null == o)
      for (h = 0; h < t.expand.nodes.length; h++) {
        var m = n[t.expand.nodes[h]];
        for (
          !0 === t.expand.allChildren &&
          OrgChart.manager._addExpandedNodeIdsIterate(m, n, f);
          m;

        )
          f.push(m.id),
            null == m.pid && null != m.stpid
              ? ((m = n[m.stpid]).min = !1)
              : (m = n[m.pid]);
      }
    else if (
      (r == OrgChart.action.expand && i.ids && "all" != i.ids) ||
      (r == OrgChart.action.collapse && i && i.expandIds)
    ) {
      var C;
      C = r == OrgChart.action.expand ? i.ids : i.expandIds;
      for (h = 0; h < C.length; h++)
        for (var b = n[(m = n[C[h]]).pid]; b; )
          f.push(b.id),
      ...
      for (var O = n[i.id]; O; ) {
        if (
          ...
          for (h = 0; h < O.childrenIds.length; h++) {
            (U = n[O.childrenIds[h]]).collapsed = !0;
          }
    ...
    for (h = 0; h < S.length; h++) {
      ...
      for (v = 0; v < m.children.length; v++) {
        (U = m.children[v]).isAssistant
          ? I.push(U.id)
          : -1 != U.tags.indexOf("right-partner")
          ? ((U.isPartner = 1), (U.children = []), A.push(U.id))
          : -1 != U.tags.indexOf("left-partner")
          ? ((U.isPartner = 2), (U.children = []), L.push(U.id))
          : -1 == U.tags.indexOf("partner") || M % 2
          ? -1 != U.tags.indexOf("partner") && M % 2
            ? ((U.isPartner = 2), (U.children = []), L.push(U.id), M++)
            : U.parentPartner
            ? (N[U.parentPartner.id] || (N[U.parentPartner.id] = []),
              N[U.parentPartner.id].push(U.id))
            : I.push(U.id)
          : ((U.isPartner = 1), (U.children = []), A.push(U.id), M++);
      }
      m.children = [];
      for (v = 0; v < A.length; v++) {
        N[(U = n[A[v]]).id] ? m.children.push(U) : m.children.splice(0, 0, U);
      }
      for (v = 0; v < L.length; v++) {
        N[(U = n[L[v]]).id] ? m.children.push(U) : m.children.splice(0, 0, U);
      }
      for (v = L.length - 1; v >= 0; v--)
        if (N[L[v]])
          for (u = 0; u < N[L[v]].length; u++)
            m.children.push(n[N[L[v]][u]]),
              E++,
              -1 == P.indexOf(L[v]) && P.push(L[v]);
      ...
      for (v = 0; v < A.length; v++)
        if (N[A[v]])
          for (u = 0; u < N[A[v]].length; u++)
            m.children.push(n[N[A[v]][u]]),
              T++,
              -1 == B.indexOf(A[v]) && B.push(A[v]);
      (m.partnerSeparation =
        Math.max(P.length, B.length) * t.partnerChildrenSplitSeparation +
    ...
    for (h = 0; h < _.length; h++) {
      if (
        (Z = e[(m = n[_[h]]).lcn ? m.lcn : "base"]).layout == OrgChart.normal ||
        !k[m.pid]
      )
        for (v = 0; v < m.subLevels; v++) {
          var z,
            F = new OrgChart.node(
              m.id + "_sub_level_index_" + v,
              m.pid,
              [],
              "subLevel"
            );
          if ((OrgChart.manager._initDinamicNode(F, m.lcn), (b = m.parent)))
            (z = b.children.indexOf(m)) > -1 &&
              (b.children.splice(z, 1), b.children.splice(z, 0, F)),
              F.children.push(m),
              (F.parent = b),
              (m.parent = F),
              (n[F.id] = F);
    ...
    for (var H in w) {
      ...
      OrgChart.manager._initDinamicNode(F, b.lcn, !0), (n[F.id] = F);
      var j = [];
      for (v = b.children.length - 1; v >= 0; v--) {
        (U = b.children[v]).isAssistant
          ? ((U.parent = null), b.children.splice(v, 1), j.splice(0, 0, U.id))
          : U.isPartner ||
            (U.parent &&
              k[U.parent.id] &&
              F &&
      ...
      for (v = j.length - 1; v >= 0; v--)
        if (v % 2 && v != j.length - 1) {
          var Y = new OrgChart.node(
            b.id + "_split_assitant_" + q,
            null,
            [],
            "split"
          );
          OrgChart.manager._initDinamicNode(Y, b.lcn, !0),
            (n[Y.id] = Y),
            j.splice(v, 0, Y.id),
            q++;
        } else v % 2 && j.splice(v, 0, F.id);
    ...
    for (var K in e) {
      if (
        (Z = e[K]).layout == OrgChart.mixed ||
        Z.layout == OrgChart.tree ||
        Z.layout == OrgChart.treeRightOffset ||
        Z.layout == OrgChart.treeLeftOffset
      ) {
        G = !0;
        break;
      }
    ...
    if (G) {
      var J = { nodes: n, config: t, action: r, actionParams: i };
      for (var H in k) {
        var Z;
        if (
          (Z = e[(b = n[H]).lcn ? b.lcn : "base"]).layout == OrgChart.mixed ||
          Z.layout == OrgChart.tree ||
          Z.layout == OrgChart.treeRightOffset ||
          Z.layout == OrgChart.treeLeftOffset
        )
          if (
            ...
            for (h = Q.length - 1; h >= 0; h--) {
              (b = (U = n[Q[h]]).parent), (U.layout = OrgChart.mixed);
              for (v = b.children.length - 1; v >= 0; v--)
            ...
            J.layout == OrgChart.treeRightOffset ||
            J.layout == OrgChart.treeLeftOffset
          ) {
            F = new OrgChart.node(b.id + "_split_0", b.id, [], "split");
            OrgChart.manager._initDinamicNode(F, b.lcn),
              (n[F.id] = F),
              (F.layout = OrgChart.tree);
            var et = [];
            for (h = J.childrenIds.length - 1; h >= 0; h--) {
              for (U = n[J.childrenIds[h]], v = 0; v < b.children.length; v++)
            ...
            for (q = 1, v = et.length - 1; v >= 0; v--)
              if (v % 2 && v != et.length - 1) {
                Y = new OrgChart.node(b.id + "_split_" + q, null, [], "split");
                OrgChart.manager._initDinamicNode(Y, b.lcn),
                  (Y.layout = OrgChart.tree),
                  (n[Y.id] = Y),
                  et.splice(v, 0, Y.id),
                  q++;
              } else v % 2 && et.splice(v, 0, F.id);
            for (v = 0; v < et.length; v += 3) {
              X = null;
              0 == v && (X = b);
              (V = n[et[v]]), ($ = n[et[v + 1]]), (W = n[et[v + 2]]);
              0 != v && (X = n[et[v - 3]]),
                0 == v || $ || (X = n[et[v - 2]]),
                (V.parent = X),
                X.children.push(V),
    ...
    return { nodes: n, roots: l, rootList: s };
  }),
  ...
  (OrgChart.manager._getResponse = function (
    ...
    if (
      ...
      if (y - 2 * i.padding >= a - n)
        switch (((_ = (a + n) / 2 - y / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            _ = (n - a) / 2 - y / 2;
        }
        ...
        switch (
          ((_ = f.x - y / 2 + OrgChart.manager._getNodeWidth(f, i) / 2),
          i.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (_ = -(y / 2 - (n - a) / 2)) < i.padding - y && (_ = i.padding - y);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.bottom_left:
          case OrgChart.orientation.top_left:
          case OrgChart.orientation.left_top:
            (_ = -(y / 2 - (a - n) / 2)) > -i.padding && (_ = -i.padding);
        }
      if (w - 2 * i.padding >= o - l)
        switch (((k = (o + l) / 2 - w / 2), i.orientation)) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            k = (l - o) / 2 - w / 2;
        }
        ...
        switch (
          ((k = -(w / 2 - (o - l) / 2)) > -i.padding && (k = -i.padding),
          i.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (k = -(w / 2 - (l - o) / 2)) < i.padding - w && (k = i.padding - w);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
    ...
    for (var L = 0; L < h.length; L++)
      OrgChart.manager._iterate2(h[L], g, i, s, c, d, m, p, r, b);
    return {
      animations: b,
      boundary: C,
      viewBox: s,
  ...
  (OrgChart.manager._iterate2 = function (t, e, r, i, a, o, n, l, s, h) {
    if (OrgChart.manager._isVisible(t, r, i, a)) {
      ...
      if (
        ...
        l &&
        l[t.id] &&
        "expandCollapseToLevel" == o.method
      ) {
        ...
        if (((c = { x: (u = l[t.id]).x, y: u.y }), "all" == o.ids && u)) {
          c = { x: u.x, y: u.y };
        ...
        if ((f = e[o.id])) {
          for (
            d = t.parent;
            null != d && -1 == o.ids.indexOf(t.id) && -1 == o.ids.indexOf(d.id);
        ...
        if (
          (null != (u = l[t.id]).x && null != u.y && (c = { x: u.x, y: u.y }),
          (p = e[o.id]) && p == t)
        )
          (d = t.parent) &&
            d.id == o.id &&
            (c = { x: p.x + p.w / 2 - t.w / 2, y: p.y + p.h / 2 - t.h / 2 });
    ...
    for (var m = 0; m < t.stChildren.length; m++)
      OrgChart.manager._iterate2(t.stChildren[m], e, r, i, a, o, n, l, s, h);
    for (m = 0; m < t.children.length; m++)
      OrgChart.manager._iterate2(t.children[m], e, r, i, a, o, n, l, s, h);
  }),
  ...
  (OrgChart.manager._setMinMaxXYAdjustifyIterate = function (
    ...
    (t.x += o.x), (t.y += o.y), OrgChart._setMinMaxXY(t, r);
  ...
  (OrgChart.manager._doNotChangePositionOfClickedNodeIfAny = function (
    ...
    var n = i.id;
    ((r == OrgChart.action.minimize && e[n].parent) ||
      (r == OrgChart.action.maximize && e[n].parent)) &&
      (n = e[n].pid);
    var l = e[n],
      s = a[n];
    return s
  ...
  (OrgChart.ui = {
    ...
    node: function (t, e, r, i, a, o, n, l, s, h) {
      ...
      c.defs &&
        (d = d.replaceAll("{randId}", OrgChart.ui._defsIds[t.templateName])),
          ...
          if (
            ...
            t.getCollapsedIds(e).length
              ...
              : ((o += OrgChart.expcollOpenTag
                ...
                (o += h.minus),
                (o += OrgChart.grCloseTag)),
            o.indexOf("{collapsed-children-count}"))
          ) {
            var g = OrgChart.collapsedChildrenCount(t, e);
            o = o.replace("{collapsed-children-count}", g);
          }
        }
        t._nodeHasHiddenParent(e) &&
          ((o += OrgChart.upOpenTag
            .replace("{id}", e.id)
            .replace("{x}", e.x)
            .replace("{y}", e.y)),
          (o += h.up),
    ...
    link: function (t, e, r, i, a, o) {
      var n = t.lcn ? t.lcn : "base",
        l = e._layoutConfigs[n],
      ...
      for (f = 0; f < t.children.length; f++) {
        ...
        var w = { node: t, cnode: m, p: b, html: O, action: o };
        ...
        for (var k in e.config.linkBinding) {
          ...
          if (I) {
            ...
            (w.value = A),
              (w.element = s[k]),
              (w.name = S),
              !1 !== OrgChart.events.publish("label", [e, w]) &&
                (OrgChart.isNEU(w.value) ||
                  OrgChart.isNEU(w.element) ||
                  (_ += w.element.replace("{val}", w.value)));
          }
        }
        "" != _ &&
          ((_ =
    ...
    svg: function (t, e, r, i, a, o) {
      return OrgChart.t(i.template, !1, o)
        .svg.replace("{w}", t)
        .replace("{h}", e)
        .replace("{viewBox}", r)
    ...
    _roundedEdge: function (t, e, r, i, a, o) {
      var n = OrgChart.LINK_ROUNDED_CORNERS;
      Math.abs(t - a) < n && (n = 0), Math.abs(e - o) < n && (n = 0);
      var l,
        s,
        h,
        c = 0;
      return (
        (t == r && t == a) || (e == i && e == o)
          ...
          : (t != a &&
              ...
              (s = i),
              e < o ? (c = i + n) : e > o && (c = i - n)),
            t < a && r == a ? (r -= n) : t > a && r == a && (r += n),
            e != o &&
              i == o &&
              ((l = r),
              (s = c = i),
              t < a ? (h = r + n) : t > a && (h = r - n)),
            e < o && i == o ? (i -= n) : e > o && i == o && (i += n)),
        {
          x1: t,
          y1: e,
          x2: r,
    ...
    _linkTopToBottom: function (t, e, r, i, a) {
      var o,
        ...
        c = 0;
      return (
        (o = t.x + t.w / 2 + r.linkAdjuster.toX),
    ...
    _linkPpTop: function (t, e, r, i, a, o) {
      var n = t.ppnodes[r.id],
        l = n.y + n.h / 2,
        s = i.minY - (i.minY - a.maxY) / 2,
        h = (i.minY - a.maxY) / t.maxSidePartnersWithChildren / 4,
        c = OrgChart.ui.__linkPpBottomTop(t, e, r, s, h, n),
        d = c.x;
      return (
        (s = c.mid),
        OrgChart.ui._linkTopToBottom({ x: d, y: l, w: 0, h: 0 }, r, o, 0, s)
      );
    },
    _linkPpBottom: function (t, e, r, i, a, o) {
      var n = t.ppnodes[r.id],
        l = n.y + n.h / 2,
      ...
      return (
        (s = c.mid),
        OrgChart.ui._linkBottomToTop({ x: d, y: l, w: 0, h: 0 }, r, o, 0, s)
      );
    },
    _linkPpLeft: function (t, e, r, i, a, o) {
      var n = t.ppnodes[r.id],
        l = i.minX - (i.minX - a.maxX) / 2,
        s = (i.minX - a.maxX) / t.maxSidePartnersWithChildren / 4,
        h = n.x + n.w / 2,
        c = OrgChart.ui.__linkPpLeftRight(t, e, r, l, s, n),
        d = c.y;
      return (
        (l = c.mid),
        OrgChart.ui._linkLeftToRight({ x: h, y: d, w: 0, h: 0 }, r, o, 0, l)
      );
    },
    _linkPpRight: function (t, e, r, i, a, o) {
      var n = t.ppnodes[r.id],
      ...
      return (
        (l = c.mid),
        OrgChart.ui._linkRightToLeft({ x: h, y: d, w: 0, h: 0 }, r, o, 0, l)
      );
    },
    __linkPpBottomTop: function (t, e, r, i, a, o) {
      var n = 0;
      return (
        1 == o.isPartner
          ? ((n =
            ...
            t.lastLeft && n < t.lastLeft.x + t.lastLeft.w / 2
              ? n < r.x + r.w / 2
          ...
          : 2 == o.isPartner &&
            ...
            t.firstRight && n > t.firstRight.x + t.firstRight.w / 2
              ? n < r.x + r.w / 2
                ? (i -= (t.indexes[r.id] + 1) * a)
    ...
    __linkPpLeftRight: function (t, e, r, i, a, o) {
      var n = 0;
      return (
        1 == o.isPartner
          ? ((n =
              ...
              t.indexes[r.id] * t.partnerChildrenSplitSeparation -
              ((t.rightIds.length - 1) * t.partnerChildrenSplitSeparation) / 2),
            t.lastLeft && n < t.lastLeft.y + t.lastLeft.h / 2
              ? n < r.y + r.h / 2
                ? (i -= (t.indexes[r.id] + 1) * a)
                : (i -= (t.rightIds.length - t.indexes[r.id]) * a)
              : n < r.y + r.h / 2
          ...
          : 2 == o.isPartner &&
            ((n =
              ...
              t.indexes[r.id] * t.partnerChildrenSplitSeparation -
              ((t.leftIds.length - 1) * t.partnerChildrenSplitSeparation) / 2),
            t.firstRight && n > t.firstRight.y + t.firstRight.h / 2
              ? n < r.y + r.h / 2
                ? (i -= (t.indexes[r.id] + 1) * a)
                : (i -= (t.leftIds.length - t.indexes[r.id]) * a)
              : n < r.y + r.h / 2
  ...
  (OrgChart.getScale = function (t, e, r, i, a, o, n, l) {
    ...
    else s = (h = e / n) > (c = r / l) ? c : h;
    return s && s > a && (s = a), s && s < o && (s = o), s;
  }),
  ...
  (OrgChart.htmlRipple = function (t) {
    ...
    var r,
      ...
      a,
      o = document.createElement("div");
    (o.className = "boc-ripple-container"),
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    var a,
      ...
      l = parseFloat(n.getAttribute("x")),
      s = parseFloat(n.getAttribute("y")),
      h = n.getAttribute("text-anchor"),
      c = n.getAttribute(OrgChart.attr.width),
      d = n.getAttribute(OrgChart.attr.text_overflow),
    ...
    if (-1 != d.indexOf("multiline")) {
      ...
      for (var x = 1, y = 1; y < C.length; y++) {
        ...
        if (
          ((O.firstChild.data += " " + C[y]), O.getComputedTextLength() > c)
        ) {
          if (
            ((O.firstChild.data = O.firstChild.data.slice(0, w)),
            x++,
            a && x > a)
          ) {
            if (o && p.children.length == a) {
    ...
    for (var n = 0; n < o; n++)
      !(function () {
        ...
        OrgChart._getDataUri(e.getAttribute(r), function (a) {
          a.success && e.setAttribute(r, a.result), t == o - 1 && i();
        });
      })();
  }),
  ...
  (OrgChart._json2csv = function (t) {
    for (
      var e = [],
        r = function (t) {
          for (var r = "", i = 0; i < e.length; i++) {
            ...
            var o = (a = null === a ? "" : a.toString()).replace(/"/g, '""');
            o.search(/("|,|\n)/g) >= 0 && (o = '"' + o + '"'),
              i > 0 && (r += ","),
              (r += o);
          }
      ...
      for (var o in t[a])
        OrgChart._arrayContains(e, o) || (e.push(o), (i += o + ","));
  ...
  (OrgChart.accentFold = function (t) {
    return (t = t.toString().toLowerCase()).replace(
      ...
      function (t, e, r, i, a, o, n, l, s, h, c) {
        return e
          ? "a"
          : r
          ? "c"
  ...
  (OrgChart.gradientCircleForDefs = function (t, e, r, i) {
    ...
    function o(t, e, r, i, o) {
      var n = a(t, e, r, o),
        l = a(t, e, r, i),
        s = o - i <= 180 ? "0" : "1";
      return ["M", n.x, n.y, "A", r, r, 0, s, 0, l.x, l.y].join(" ");
    }
    return (
      ...
      `<linearGradient id="${t}_linearColors1" x1="0" y1="0" x2="1" y2="1">\n            <stop offset="0%" stop-color="${
        ...
        e[0]
      }"></stop>\n        </linearGradient>        \n        <g id="${t}">\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors1)" d="${o(
        r,
        r,
        r,
        1,
        60
      )}"  />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors2)" d="${o(
        r,
        r,
        r,
        60,
        120
      )}"/>\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors3)" d="${o(
        r,
        r,
        r,
        120,
        180
      )}" />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors4)" d="${o(
        r,
        r,
        r,
        180,
        240
      )}" />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors5)" d="${o(
        r,
        r,
        r,
        240,
        300
      )}" />\n            <path stroke-width="${i}" fill="none" stroke="url(#${t}_linearColors6)" d="${o(
        r,
        r,
        r,
        300,
  ...
  (OrgChart.prototype.zoom = function (t, e, r, i) {
    ...
    !0 === t
      ...
      : ((a[2] = a[2] / t), (a[3] = a[3] / t)),
      e || (e = [50, 50]),
      (a[0] = o[0] - (a[2] - n) / (100 / e[0])),
      (a[1] = o[1] - (a[3] - l) / (100 / e[1]));
  ...
  (OrgChart.pdfPrevUI._handler = function (t, e, r) {
    ...
    for (
      ...
      if (f) {
        var C = o - f.offsetHeight - 7;
        f.style.top = C + "px";
      }
      if (m) {
        var b = n - m.offsetHeight - 7;
        m.style.bottom = b + "px";
      }
      g.close();
    }
  ...
  (OrgChart._exportHtml = function (t, e, r, i, a, o, n, l) {
  ...
  (OrgChart.prototype._slinks = function (t, e) {
    ...
    function o(e, o, n) {
      ...
      var C = o.level;
      if ((o.subLevels && (C += o.subLevels), m == C))
        switch (((h = o), g.orientation)) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            s.push([f.p, f.q]),
              s.push([f.p, f.q - u / 3]),
          ...
          if (
            (v.id == o.id
              ...
              : OrgChart._intersects(v, f, t.config) &&
                ((f = OrgChart._addPoint(v, s, t.config, f, c)), (O = !0)),
            v.id != o.id)
          ) {
            for (; x; ) {
              if (x.id == o.id) {
              ...
              OrgChart._intersects(x, f, t.config) &&
                ((f = OrgChart._addPoint(x, s, t.config, f, c)), (O = !0)),
                (x = x.leftNeighbor);
            }
            for (; y; ) {
              if (y.id == o.id) {
              ...
              OrgChart._intersects(y, f, t.config) &&
                ((f = OrgChart._addPoint(y, s, t.config, f, c)), (O = !0)),
                (y = y.rightNeighbor);
            }
          }
          if (!O) {
            var w = s[s.length - 1][0],
              _ = 0;
            if (v.parent)
              switch (
                ((u = g.levelSeparation),
                ...
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                  (w = v.parent.x + v.parent.w + u * (2 / 3)),
                    (_ = s[s.length - 1][1]);
                  break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  (w = v.parent.x - u * (2 / 3)), (_ = s[s.length - 1][1]);
              }
            s.push([w, _]);
          }
          b = v;
      ...
      (r +=
        (
          ...
          .replace("{from}", e.id)
          .replace("{to}", o.id) +
        p.link.replaceAll("{d}", M) +
        '<path stroke="transparent" stroke-width="15" fill="none" d="' +
        M +
        '" />'),
        (r += OrgChart.grCloseTag);
    }
    for (var n = 0; n < this.config.slinks.length; n++) {
      var l = this.config.slinks[n],
        s = t.getNode(l.from),
        h = t.getNode(l.to);
      s &&
        h &&
        ...
        (s.level >= h.level ? o(s, h, !1) : o(h, s, !0));
    }
    e.content += r;
  }),
  ...
  OrgChart.events.on("redraw", function (t, e) {
    if (t.config.miniMap) {
      ...
      var a = t.response.boundary.maxX - t.response.boundary.minX,
        o = t.response.boundary.maxY - t.response.boundary.minY,
        n = Math.min(r.width / a, r.height / o),
        l = (r.width - a * n) / 2,
        s = (r.height - o * n) / 2;
      i.clearRect(0, 0, r.width, r.height),
        i.translate(
          -t.response.boundary.minX * n + l,
          -t.response.boundary.minY * n + s
        ),
        i.scale(n, n);
      var h = 0,
        c = [];
      !(function t(e, r) {
        if (Array.isArray(r)) for (var a = 0; a < r.length; a++) t(e, r[a]);
        else {
            ...
            h++,
              c.includes(r.id) ||
                (1 == h
                  ...
                  : 3 == h && (i.fillStyle = OrgChart.miniMap.colors[2]),
                i.beginPath(),
                i.fillRect(r.x, r.y, r.w, r.h),
                i.strokeRect(r.x, r.y, r.w, r.h),
                c.push(r.id)),
  ...
  (OrgChart.miniMap._getCanvas = function (t) {
    if (
      !(e = t.element.querySelector("[" + OrgChart.attr.id + '="mini-map"]'))
    ) {
      var e;
  ...
  (OrgChart._search = {}),
  (OrgChart._search.search = function (t, e, r, i, a, o) {
    var n = [],
    ...
    for (var s = {}, h = 0; h < t.length; h++)
      for (var c = t[h], d = 0; d < r.length; d++) {
        ...
        if (!OrgChart.isNEU(c[g])) {
          var p = c[g];
          if (
            null != (e = OrgChart._search.searchAndComputeScore(l, p, g, o))
          ) {
            var u = c.id;
            if (s[u]) {
              if (s[u] && s[u] < e.__score) {
                ...
                for (var f = n.length - 1; f >= 0; f--)
                  n[f].id == u && n.splice(f, 1);
                OrgChart._search.addNodeToResult(n, i, c, e, g, a);
              }
            } else
              (s[u] = e.__score),
                OrgChart._search.addNodeToResult(n, i, c, e, g, a);
  ...
  (OrgChart._search.addNodeToResult = function (t, e, r, i, a, o) {
    var n = {};
    (n.id = r.id), OrgChart.isNEU(r[o]) || (n[o] = r[o]);
    for (var l = 0; l < e.length; l++) {
      var s = e[l];
      OrgChart.isNEU(r[s]) || (OrgChart.isNEU(n[s]) && (n[s] = r[s]));
    }
    null != i &&
      (OrgChart.isNEU(n.__score) && (n.__score = i.__score),
      OrgChart.isNEU(n.__searchField) && (n.__searchField = a),
      OrgChart.isNEU(n.__searchMarks) && (n.__searchMarks = i.__searchMarks)),
      t.push(n);
  }),
  (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
    ...
    var a = e.toLowerCase(),
      o = OrgChart._search.searchIndexesOf(a, t);
    ...
    if (o.length) {
      ...
      for (var c = 0; c < o.length; c++)
        if (
          ((l += o[c].length),
          o[c].start < s && (s = o[c].start),
          c >= 1 && o[c - 1].start > o[c].start)
        ) {
          h = 0;
          break;
        }
    ...
    for (c = o.length - 1; c >= 0; c--)
      f = (f = f.insert(o[c].start + o[c].length, "</mark>")).insert(
        o[c].start,
        "<mark>"
      );
  ...
  (OrgChart._search.searchIndexesOf = function (t, e) {
    ...
    if (!OrgChart.isNEU(t))
      for (var i = 0; i < e.length; i++) {
        var a = e[i];
        if (!OrgChart.isNEU(a))
          for (var o = 0; (o = t.indexOf(a, o)) > -1; )
            r.push({ length: a.length, start: o }), (o += a.length);
      }
    return (
      r.sort(function (t, e) {
  ...
  (OrgChart.state._put = function (t, e, r, i, a, o, n) {
    if (n) {
      var l = OrgChart.state._buildStateNames(n.name),
        s = {
      ...
      n.writeToIndexedDB &&
        ...
        OrgChart.idb.put(s, function (t) {
          0 == t && console.error("Cannot write row - " + n.name);
        })),
        n.writeToLocalStorage &&
          OrgChart.localStorage.setItem(n.name, JSON.stringify(s));
    }
  }),
    ...
    if (t) {
      ...
      if (t.readFromUrlParams) {
        ...
        if (
          ...
          o.has(a.paramExp) &&
          o.has(a.paramMin) &&
          o.has(a.paramAdjustify)
        ) {
          var n = {},
            l = parseFloat(o.get(a.paramScale)),
            s = parseFloat(o.get(a.paramX)),
            h = parseFloat(o.get(a.paramY));
          ((d = [])[0] = s),
            (d[1] = h),
            (d[2] = e / l),
            (d[3] = r / l),
            ...
            (n.x = s),
            (n.y = h),
            (n.exp = o.get(a.paramExp).split("*")),
            (n.min = o.get(a.paramMin).split("*"));
          var c = o.get(a.paramAdjustify).split("*");
          return (
            (n.adjustify = { x: parseFloat(c[0]), y: parseFloat(c[1]) }),
            void i(n)
          );
        }
      ...
      if (t.readFromLocalStorage) {
        var d;
        if (null != (n = OrgChart.localStorage.getItem(t.name)))
          return (
            (n = JSON.parse(n)),
            ((d = [])[0] = n.x),
            (d[1] = n.y),
      ...
      t.readFromIndexedDB &&
        OrgChart.idb.read(t.name, function (a, o) {
  ...
  (OrgChart.prototype.magnify = function (t, e, r, i, a) {
    ...
    if (o || n) {
      ...
      if (
        ...
        (n = n.cloneNode(!0)), this.getSvg().appendChild(n);
      var s = OrgChart._getTransform(n),
        h = JSON.parse(JSON.stringify(s));
      (h[0] = e), (h[3] = e);
      var c = o.w + o.w * (e - 1),
        d = o.h + o.h * (e - 1);
      (h[4] += (o.w - c) / 2), (h[5] += (o.h - d) / 2);
      var g = OrgChart.anim(
        n,
        { transform: s },
        { transform: h },
  ...
  (OrgChart.prototype._windowKeyDownHandler = function (t, e) {
    ...
    if (r) {
      var a = i ? this.getNode(i) : null,
        o = { node: a, data: i ? this.get(i) : null, event: e };
      if (!1 !== OrgChart.events.publish("key-down", [this, o]) && a)
        if ("KeyF" == e.code) this.searchUI.find("");
          ...
          if ((s = this.getNode(a.pid))) {
            var n = s.childrenIds.indexOf(a.id);
            if (++n < s.childrenIds.length) {
              var l = s.childrenIds[n];
              (this._keyNavigationActiveNodeId = l), this.center(l);
            }
          }
        } else if ("ArrowLeft" == e.code) {
          if ((s = this.getNode(a.pid))) {
            n = s.childrenIds.indexOf(a.id);
            if (--n >= 0) {
              l = s.childrenIds[n];
              (this._keyNavigationActiveNodeId = l), this.center(l);
            }
  ...
  (OrgChart._keyNavigation = function (t) {
    ...
    if (
      ...
      var a,
        o = { text: "", id: t._keyNavigationActiveNodeId };
      if (
        (OrgChart.events.publish("screen-reader-text", [t, o]),
        !OrgChart.isNEU(o.text))
      )
  ...
  (OrgChart.elements.textbox = function (t, e, r, i) {
    ...
    return (
      e.btn &&
        (o = `<a href="#" boc-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`),
      {
  ...
  (OrgChart.elements.checkbox = function (t, e, r, i) {
    var a = OrgChart.elements._vidrf(t, e, i);
    if (a.doNotRender) return { html: "" };
    var o = a.value ? "checked" : "",
      n = i ? 'onclick="return false;"' : "";
    return {
      html: `<div class="boc-form-field"  style="min-width: ${r};" >\n                        <label class="boc-checkbox" data-boc-input="" ${a.disabledAttribute}>\n                            <input ${o} ${n} data-binding="${a.binding}" type="checkbox"><span class="boc-checkbox-checkmark" type="checkbox"></span>${a.label}\n                        </label>\n                    </div>`,
      id: a.id,
      value: o,
    };
  }),
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${
            ...
            for (var t = "", e = 0; e < a.options.length; e++) {
              var r = a.options[e];
              t += `<option ${r.value == a.value ? "selected" : ""} value="${
                r.value
              }">${r.text}</option>`;
            }
            return t;
  ...
  (OrgChart.elements._vidrf = function (t, e, r) {
    ...
    if (
      ...
      for (var o in e.vlidators)
        i.vlidators += `data-v-${o}="${e.vlidators[o]}" `;
    return i;
  }),
  ...
  (OrgChart.input.validate = function (t) {
    ...
    var a = t.getAttribute("data-v-required"),
      o = t.getAttribute("data-v-password"),
      n = t.getAttribute("data-v-email"),
    ...
    return a && "" == e.value
      ? ((r.innerHTML +=
        ...
        !1)
      : o && !OrgChart.input.validatePassword(e.value)
      ? ((r.innerHTML +=
          '<span class="boc-validation-error-message">&nbsp;' + o + "</span>"),
        e.classList.add("boc-validation-error"),
        !1)
      : n && !OrgChart.input.isValidEmail(e.value)
      ? ((r.innerHTML +=
  ...
  (OrgChart.input.validateAndGetData = function (t) {
    ...
    if (!r) return !1;
    var o = t.querySelectorAll("[data-binding]"),
      n = {};
  ...
  (OrgChart.prototype.onExpandCollpaseButtonClick = function (t) {
    return this.on("expcollclick", function (e, r, i, a) {
      var o = { collapsing: r, id: i, ids: a };
      return t.call(e, o);
    });
  }),
  (OrgChart.prototype.onExporStart = function (t) {
    return this.on("exportstart", function (e, r) {
      return t.call(e, r);
    });
  }),
  (OrgChart.prototype.onExporEnd = function (t) {
  ...
  (OrgChart.remote._fromResDTO = function (t, e, r, i, a) {
    ...
    (t.x = o.p[0]),
      ...
      (t.w = o.p[2]),
      (t.h = o.p[3]),
      null != o.ln && (t.leftNeighbor = a[o.ln]),
      null != o.rn && (t.rightNeighbor = a[o.rn]);
    for (var n = 0; n < t.stChildren.length; n++)
      OrgChart.remote._fromResDTO(t.stChildren[n], e, r, i, a);
    for (n = 0; n < t.children.length; n++)
      OrgChart.remote._fromResDTO(t.children[n], e, r, i, a);
  }),
  ...
  (OrgChart.remote._setPositions = function (t, e, r, i) {
    for (
      var a = [], o = [], n = OrgChart.remote._toReqLayoutConfigsDTO(e), l = 0;
      l < t.length;
      l++
    )
      o.push(t[l].id), OrgChart.remote._toReqDTO(t[l], a);
    var s = { n: a, c: n, r: o, v: "8.02.19" };
    if (
