...
(FamilyTree._defaultConfig = function (e) {
  ...
  (FamilyTree.prototype.removeNode = function (e, t, i) {
    ...
    if (this.canRemove(e)) {
      ...
      var c = { removeNodeId: e, updateNodesData: n, addNodesData: [] };
      !1 !== this._fireUpdate_addUpdateRemove(c, i) &&
        (this._draw(!1, FamilyTree.action.update, null, function () {
          r.config.sticky &&
            FamilyTree._moveToBoundaryArea(
              r.getSvg(),
    ...
    if (this.config.interactive) {
      ...
      this.config.enableTouch || FamilyTree.isMobile()
        ...
        : (this._addEvent(e, "mousedown", this._globalMouseDownHandler),
          ...
          (this.config.mouseScroll != FamilyTree.action.zoom &&
            this.config.mouseScroll != FamilyTree.action.ctrlZoom) ||
    ...
    if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
      ...
      if (
        ...
        f.menu)) {
          ...
          S.setAttribute("cx", 0),
            S.setAttribute("cy", 0),
            S.setAttribute("r", a.nodeCircleMenuButton.radius),
            S.setAttribute("fill", _),
            S.setAttribute("stroke-width", "1"),
            S.setAttribute("stroke", a.nodeCircleMenuButton.stroke),
            k.appendChild(S),
            k.appendChild(C),
            (k.innerHTML += x),
            h.appendChild(k);
    ...
    if (-1 != m.indexOf("multiline")) {
      ...
      for (var F = 1, x = 1; x < g.length; x++) {
        ...
        if (
          ...
          (T = document.createElementNS(p, "tspan")).setAttributeNS(
            null,
            "x",
            l
          ),
      ...
      if (null != h.innerHTML) (k = h.innerHTML), (h.innerHTML = "");
        ...
        for (x = h.childNodes.length - 1; x >= 0; x--)
          (C = XMLSerializer().serializeToString(h.childNodes[x]) + C),
  ...
  (FamilyTree.prototype._mouseScrollHandler = function (e, t) {
    if (this.config.mouseScroll != FamilyTree.action.ctrlZoom || t.ctrlKey) {
      var i = this,
        r = !1,
            ...
            if (s.left || s.right || s.up || s.down) {
              ...
              for (
                ...
                if (r.hasAttribute && r.hasAttribute(FamilyTree.attr.node_id)) {
                  var S = r.getAttribute(FamilyTree.attr.node_id);
                  (c = S), (m = r);
                  break;
                }
                r = r.parentNode;
              ...
              if (
                ...
                !1 ===
                  FamilyTree.events.publish("drag", [
                    o.nodeCircleMenuUI,
                    { from: S, menuItem: n, menuItemName: a },
                  ]) && F(),
                  (e._dragEventFired = !0);
              f.setAttribute("transform", "matrix(" + u.toString() + ")");
            }
          ...
          if (c) {
            ...
            if (g.left || g.right || g.up || g.down) {
              ...
              if (null != o) {
                ...
                for (
                  var C = s.getNode(o),
                    S = FamilyTree.getStParentNodes(C),
                    I = 0;
                  I < S.length;
                  I++
                ) {
                  var N = s.getNodeElement(S[I].id);
  ...
  (FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
    ...
    if ("pan" == s.type) {
      ...
      (d.style.display = "inherit"),
        ...
        FamilyTree.anim(
          d,
          { transform: [0, 0, 0, 0, m, p], opacity: 0 },
          { transform: [1 / n, 0, 0, 1 / n, m, p], opacity: 1 },
          300,
          FamilyTree.anim.outBack
        );
    }
  ...
  (FamilyTree.manager._initNode = function (e, t, i, r, a, n, o, l, s, d, c) {
    ...
    for (var p = 0; p < e.childrenIds.length; p++) {
      var h = t[e.childrenIds[p]];
      if (
        (FamilyTree.manager._setCollpasedProperty(h, m, s, l, a, r, c),
        !h.collapsed)
      ) {
        if (((h.parent = e), null != h.ppid)) {
          var f = t[h.ppid];
          f && (h.parentPartner = f);
        }
        (-1 != h.tags.indexOf("left-partner") ||
          -1 != h.tags.indexOf("right-partner") ||
          -1 != h.tags.indexOf("partner") ||
          h.parentPartner) &&
          -1 == d.indexOf(e.id) &&
          d.push(e.id),
          e.children.push(h);
    ...
    if (
      ...
      for (p = 0; p < e.stChildrenIds.length; p++) {
        ((h = t[e.stChildrenIds[p]]).stParent = e), e.stChildren.push(h);
      }
    var u = FamilyTree.t(e.templateName, e.min);
    (e.w = u && u.size ? u.size[0] : 0),
      (e.h = u && u.size ? u.size[1] : 0),
      (e.padding = u && u.padding ? u.padding : [0, 0, 0, 0]),
      null != r && (e.level = r),
      i && (e.lcn = i);
  ...
  (FamilyTree.manager._iterate = function (
    ...
    if (
      (FamilyTree.manager._initNode(t, i, s, r, m, d, c, p, h, f, u),
      ...
      if (
        ...
        ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
          y.length > 1 &&
          y.length == t.parent.children.length - g - b) ||
          (!FamilyTree.MIXED_LAYOUT_ALL_NODES && y.length > 1)) &&
          (l[t.pid] = y);
      }
    } else if (
      !t.isAssistant &&
      ...
      for (y = [], g = 0, b = 0, T = 0; T < t.parent.children.length; T++) {
        var v;
        -1 == (v = t.parent.children[T]).tags.indexOf("partner") &&
        -1 == v.tags.indexOf("left-partner") &&
        -1 == v.tags.indexOf("right-partner") &&
      ...
      ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
        y.length > 1 &&
        y.length == t.parent.childrenIds.length - g - b) ||
        (!FamilyTree.MIXED_LAYOUT_ALL_NODES && y.length > 1)) &&
        (l[t.pid] = y);
    }
    t.stChildren.length &&
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o) {
    for (var l = i.nodes, s = [], d = 0; d < l.length; d++) {
      ...
      c = FamilyTree.STRING_TAGS
        ...
        ? m.tags.slice(0)
        : [];
      var p = FamilyTree._getTemplate(c, i.tags, i.template),
        h = new FamilyTree.node(m.id, m.pid, c, p);
      FamilyTree.isNEU(m.ppid) || (h.ppid = m.ppid),
        FamilyTree.isNEU(m.stpid) || (h.stpid = m.stpid),
        null != i.orderBy &&
          (h.order = FamilyTree.manager._getOrderFieldValue(m, i.orderBy)),
        (e[m.id] = h),
        s.push(m.id);
    }
    null != i.orderBy &&
    ...
    for (d = 0; d < s.length; d++) {
      var f = s[d],
        ...
        y = e[h.stpid],
        g = e[h.pid];
      if ((y || (h.stpid = null), g || (h.pid = null), y)) {
        var b = n ? n[y.id] : null;
        b && (y.min = b.min), y.stChildrenIds.push(h.id);
      } else
        g
          ? (u && ((h.collapsed = u.collapsed), (h.min = u.min)),
            g.childrenIds.push(h.id))
          : (u && ((h.collapsed = u.collapsed), (h.min = u.min)),
            t.push(h),
            o.push(h.id));
      r == FamilyTree.action.init && (h.min = FamilyTree._getMin(h, i));
    }
  }),
  (FamilyTree.manager._createNodes = function (e, t, i, r, a, n) {
    ...
    if (
      ...
      for (var d = 0; d < e.roots.length; d++) {
        ...
        if (c && i == FamilyTree.action.centerNode) {
          ...
          for (var p = o[r.id]; null != p.pid || null != p.stpid; )
            p = null == p.pid && null != p.stpid ? o[p.stpid] : o[p.pid];
          m == p && (c = m);
        }
        if (c) {
          for (var h = !1, f = 0; f < l.length; f++)
            if (l[f].id == c.id) {
              h = !0;
              break;
            }
          if (!h) {
            if (!FamilyTree.isNEU(c.pid))
              (P = (b = o[c.pid]).childrenIds.indexOf(c.id)) > -1 &&
                b.childrenIds.splice(P, 1);
            l.push(c);
          }
        }
      }
    ...
    if (i == FamilyTree.action.init && e.expand && e.expand.nodes && null == n)
      for (d = 0; d < e.expand.nodes.length; d++) {
        var y = o[e.expand.nodes[d]];
        for (
          !0 === e.expand.allChildren &&
          FamilyTree.manager._addExpandedNodeIdsIterate(y, o, u);
          y;

        )
          u.push(y.id),
            null == y.pid && null != y.stpid
              ? ((y = o[y.stpid]).min = !1)
              : (y = o[y.pid]);
      }
    else if (
    ...
    for (d = 0; d < C.length; d++) {
      ...
      var S = [],
        ...
        B = [],
        O = [];
      for (v = 0; v < y.children.length; v++) {
        (U = y.children[v]).isAssistant
          ? S.push(U.id)
          : -1 != U.tags.indexOf("right-partner")
          ? ((U.isPartner = 1), (U.children = []), I.push(U.id))
          : -1 != U.tags.indexOf("left-partner")
          ? ((U.isPartner = 2), (U.children = []), N.push(U.id))
          : -1 == U.tags.indexOf("partner") || M % 2
          ? -1 != U.tags.indexOf("partner") && M % 2
            ? ((U.isPartner = 2), (U.children = []), N.push(U.id), M++)
            : U.parentPartner
            ? (A[U.parentPartner.id] || (A[U.parentPartner.id] = []),
              A[U.parentPartner.id].push(U.id))
            : S.push(U.id)
          : ((U.isPartner = 1), (U.children = []), I.push(U.id), M++);
      }
      y.children = [];
      for (v = 0; v < I.length; v++) {
        A[(U = o[I[v]]).id] ? y.children.push(U) : y.children.splice(0, 0, U);
      }
      for (v = 0; v < N.length; v++) {
        A[(U = o[N[v]]).id] ? y.children.push(U) : y.children.splice(0, 0, U);
      }
      for (v = N.length - 1; v >= 0; v--)
        if (A[N[v]])
          for (f = 0; f < A[N[v]].length; f++)
            y.children.push(o[A[N[v]][f]]),
              L++,
              -1 == O.indexOf(N[v]) && O.push(N[v]);
      ...
      for (v = 0; v < I.length; v++)
        if (A[I[v]])
          for (f = 0; f < A[I[v]].length; f++)
            y.children.push(o[A[I[v]][f]]),
              E++,
              -1 == B.indexOf(I[v]) && B.push(I[v]);
      (y.partnerSeparation =
        Math.max(O.length, B.length) * e.partnerChildrenSplitSeparation +
    ...
    for (d = 0; d < w.length; d++) {
      if (
        (Z = t[(y = o[w[d]]).lcn ? y.lcn : "base"]).layout ==
          FamilyTree.normal ||
        !k[y.pid]
      )
        for (v = 0; v < y.subLevels; v++) {
          var P,
            z = new FamilyTree.node(
              y.id + "_sub_level_index_" + v,
              y.pid,
              [],
              "subLevel"
            );
          if ((FamilyTree.manager._initDinamicNode(z, y.lcn), (b = y.parent)))
            (P = b.children.indexOf(y)) > -1 &&
              (b.children.splice(P, 1), b.children.splice(P, 0, z)),
              z.children.push(y),
              (z.parent = b),
              (y.parent = z),
              (o[z.id] = z);
    ...
    for (var D in _) {
      ...
      if (j.length % 2) {
        var H = o[j[j.length - 1]],
          R = new FamilyTree.node(H.id + "_mirror", H.pid, [], "mirror");
        FamilyTree.manager._initDinamicNode(R, H.lcn, !0),
          (H._m = R.id),
          (R.isAssistant = !0),
          (R.w = H.w),
          (R.h = H.h),
          (o[R.id] = R),
          j.splice(j.length - 1, 0, R.id);
      }
      var $ = 1;
      for (v = j.length - 1; v >= 0; v--)
        if (v % 2 && v != j.length - 1) {
          var q = new FamilyTree.node(
            b.id + "_split_assitant_" + $,
            null,
            [],
            "split"
          );
          FamilyTree.manager._initDinamicNode(q, b.lcn, !0),
            (o[q.id] = q),
            j.splice(v, 0, q.id),
            $++;
        } else v % 2 && j.splice(v, 0, z.id);
    ...
    if (G) {
      var J = { nodes: o, config: e, action: i, actionParams: r };
      for (var D in k) {
        var Z;
        if (
          (Z = t[(b = o[D]).lcn ? b.lcn : "base"]).layout == FamilyTree.mixed ||
          Z.layout == FamilyTree.tree ||
          Z.layout == FamilyTree.treeRightOffset ||
          Z.layout == FamilyTree.treeLeftOffset
        )
          if (
            ...
            for ($ = 1, v = te.length - 1; v >= 0; v--)
              if (v % 2 && v != te.length - 1) {
                q = new FamilyTree.node(
                  b.id + "_split_" + $,
                  null,
                  [],
                  "split"
                );
                FamilyTree.manager._initDinamicNode(q, b.lcn),
                  (q.layout = FamilyTree.tree),
                  (o[q.id] = q),
                  te.splice(v, 0, q.id),
                  $++;
            ...
            for (v = 0; v < te.length; v += 3) {
              X = null;
              0 == v && (X = b);
              (Y = o[te[v]]), (V = o[te[v + 1]]), (W = o[te[v + 2]]);
              0 != v && (X = o[te[v - 3]]),
                0 == v || V || (X = o[te[v - 2]]),
                (Y.parent = X),
                X.children.push(Y),
    ...
    return { nodes: o, roots: l, rootList: s };
  }),
      ...
      if (
        ...
        if (
          ...
          switch (r.orientation) {
            ...
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
              m.options.vertical || (S = p[m.id]);
              break;
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
            case FamilyTree.orientation.left:
            case FamilyTree.orientation.left_top:
              m.options.horizontal || (S = p[m.id]);
          }
          S && (S = FamilyTree.manager._getMostDeepChild(S, p));
        }
      } else (S = p[m.id]), (S = FamilyTree.manager._getMostDeepChild(S, p));
      if (!FamilyTree.FIXED_POSITION_ON_CLICK && S)
        switch (r.orientation) {
          case FamilyTree.orientation.top:
          case FamilyTree.orientation.top_left:
            var I = S.y + S.h - s[3] + r.padding;
            s[1] < I && (s[1] = I);
            break;
          case FamilyTree.orientation.bottom:
          case FamilyTree.orientation.bottom_left:
          ...
          case FamilyTree.orientation.left:
          case FamilyTree.orientation.left_top:
            I = S.x + S.w - s[2] + r.padding;
            s[0] < I && (s[0] = I);
        }
    }
    for (var N = 0; N < d.length; N++)
      FamilyTree.manager._iterate2(d[N], p, r, s, c, m, y, h, i, b);
    return {
      animations: b,
      boundary: g,
      viewBox: s,
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o) {
    for (
      ...
      (y.ftChildrenIds = []),
        (y.rids = []),
        FamilyTree.isNEU(f.ppid) || (y.ppid = f.ppid),
        FamilyTree.isNEU(f.stpid) || (y.stpid = f.stpid),
        FamilyTree.isNEU(f.mid) || (y.mid = f.mid),
        FamilyTree.isNEU(f.fid) || (y.fid = f.fid),
        FamilyTree.isNEU(f.gender) || (y.gender = f.gender),
        Array.isArray(f.pids) ? (y.pids = f.pids) : (y.pids = []),
        null != i.orderBy &&
          (y.order = FamilyTree.manager._getOrderFieldValue(f, i.orderBy)),
        (e[f.id] = y),
        s.push(f.id),
        FamilyTree.isNEU(y.stpid)
          ? (FamilyTree.isNEU(y.mid) ||
              (c[y.mid] || (c[y.mid] = []), c[y.mid].push(y.id)),
            FamilyTree.isNEU(y.fid) ||
              (c[y.fid] || (c[y.fid] = []), c[y.fid].push(y.id)),
            FamilyTree.isNEU(y.mid) &&
              FamilyTree.isNEU(y.fid) &&
              FamilyTree.isNEU(y.stpid) &&
              (d.has(y.id) || d.push(y.id)))
          : (m[y.stpid] || (m[y.stpid] = []), m[y.stpid].push(y.id));
    }
    null != i.orderBy &&
      s.sort(function (t, r) {
        var a = e[t].order,
    ...
    for (p = 0; p < o.length; p++)
      for (var T = 0; T < o.length; T++)
        if (T != p) {
          for (var v = o[p], F = o[T], x = !1, _ = 0; _ < v.length; _++)
            if (F.has(v[_])) {
              x = !0;
              break;
            }
          x && ((o[p] = v.concat(F).unique()), (o[T] = []));
        }
  ...
  (FamilyTree.templates.base = {
    ...
    link: '<path stroke-linejoin="round" stroke="#000000" stroke-width="1px" fill="none" d="{rounded}" />',
    assistanseLink:
      '<path stroke-linejoin="round" stroke="#000000" stroke-width="2px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} {xd},{yd} L{xe},{ye}"/>',
    pointer:
...
//     "<text " +
//     FamilyTree.attr.width +
//     '="230" style="font-size: 18px;font-weight:bold;" fill="#000000" x="10" y="90" text-anchor="start">{val}</text>'),
...
//     FamilyTree.icon.teddy(70, 70, "#F57C00", 10, 40)),
      ...
      for (var h in o) {
        ...
        if (
          ...
          if (null != p.value && null != p.value && null != p.element)
            FamilyTree._lblIsImg(r, h) ||
              "string" != typeof p.value ||
              (p.value = FamilyTree.wrapText(p.value, p.element)),
              (m += p.element
      ...
      for (u = 0; u < e.children.length; u++) {
        ...
        if (f && -1 != f.ids.indexOf(y.id))
          ...
          switch (l.orientation) {
            ...
            case FamilyTree.orientation.top_left:
              if (1 == y.isPartner)
                b = FamilyTree.ui._linkLeftToRight(e, y, s, m);
              else if (2 == y.isPartner)
                b = FamilyTree.ui._linkRightToLeft(e, y, s, m);
              else {
            ...
            case FamilyTree.orientation.right_top:
              if (1 == y.isPartner)
                b = FamilyTree.ui._linkTopToBottom(e, y, s, m);
              else if (2 == y.isPartner)
                b = FamilyTree.ui._linkBottomToTop(e, y, s, m);
              else {
  ...
  (FamilyTree.xScrollUI.prototype.addListener = function (e) {
    var t = this;
    if (
      (this.config.mouseScroll == FamilyTree.action.xScroll ||
        this.config.mouseScroll == FamilyTree.action.scroll) &&
      this.bar
    ) {
      ...
      !(function (e, i, r) {
        ...
        e.addEventListener(
          ...
          function (e) {
            var r = 0;
            if (t.config.mouseScroll == FamilyTree.action.xScroll)
              (r = e.deltaX || e.wheelDeltaX) ||
                (r = e.deltaY || e.wheelDeltaY);
            else if (
              t.config.mouseScroll == FamilyTree.action.scroll &&
              !(r = e.shiftKey
  ...
  (FamilyTree.yScrollUI.prototype.addListener = function (e) {
    var t = this;
    if (
      this.config.mouseScroll == FamilyTree.action.yScroll ||
      this.config.mouseScroll == FamilyTree.action.scroll
    ) {
      var i = FamilyTree._getScrollSensitivity();
      !(function (e, i, r) {
        ...
        e.addEventListener(
          ...
          function (e) {
            var r = 0;
            if (t.config.mouseScroll == FamilyTree.action.yScroll)
              (r = e.deltaY || e.wheelDeltaY) ||
                (r = e.deltaX || e.wheelDeltaX);
            else if (
              t.config.mouseScroll == FamilyTree.action.scroll &&
    ...
    function n(t, n, o) {
      ...
      switch ((h = FamilyTree.slinkTemplates[_]).labelPosition) {
        case "start":
          ...
          break;
        case "middle":
          var S = Math.ceil(s.length / 2);
          (w = s[S]),
            (k = s[S - 1]),
            (C = { x: (w[0] + k[0]) / 2, y: (w[1] + k[1]) / 2 });
          break;
        case "end":
    ...
    for (var s = {}, d = 0; d < e.length; d++)
      for (var c = e[d], m = 0; m < i.length; m++) {
        ...
        if (!FamilyTree.isNEU(c[p])) {
          var h = c[p];
          if (
            null != (t = FamilyTree._search.searchAndComputeScore(l, h, p, n))
          ) {
            var f = c.id;
            if (s[f]) {
              if (s[f] && s[f] < t.__score) {
                ...
                FamilyTree._search.addNodeToResult(o, r, c, t, p, a);
              }
            } else
              (s[f] = t.__score),
                FamilyTree._search.addNodeToResult(o, r, c, t, p, a);
  ...
  (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
    ...
    for (c = n.length - 1; c >= 0; c--)
      u = (u = u.insert(n[c].start + n[c].length, "</mark>")).insert(
        n[c].start,
        "<mark>"
      );
      ...
      for (var r = 0; r < t.length; r++) {
        ...
        if (!FamilyTree.isNEU(a))
          for (var n = 0; (n = e.indexOf(a, n)) > -1; )
            i.push({ length: a.length, start: n }), (n += a.length);
      }
    return (
      i.sort(function (e, t) {
  ...
  (FamilyTree.prototype.showTreeMenu = function (e) {
    ...
    if (
      ("male" == c.gender
        ? ((h.templateName = "wife"), (h._ft_data.gender = "female"))
        : "female" == c.gender &&
          ((h.templateName = "husband"), (h._ft_data.gender = "male")),
      c.pids.push(h.id),
      this.add(h),
      c.pids)
    )
      for (s = 0; s < c.pids.length; s++) {
        if (
          ...
          var f = {
              ...
              _ft_childData: { mid: t.id, fid: h.id, gender: "male" },
              _ft_parentData: { pids: [e] },
              _ft_id: e,
            },
            u = {
              id: "_ft_daughter_" + s,
              ...
              _ft_method: "addChildAndPartnerNodes",
              _ft_childData: { mid: t.id, fid: h.id, gender: "female" },
              _ft_parentData: { pids: [e] },
              _ft_id: e,
            };
          "male" == c.gender && "female" == h._ft_data.gender
            ? ((f._ft_childData.mid = h.id),
              (f._ft_childData.fid = c.id),
              (f._ft_parentData.gender = h._ft_data.gender),
              (u._ft_childData.mid = h.id),
              (u._ft_childData.fid = c.id),
              (u._ft_parentData.gender = h._ft_data.gender))
            : "female" == c.gender &&
              "male" == h._ft_data.gender &&
              ((f._ft_childData.mid = c.id),
              (f._ft_childData.fid = h.id),
              (f._ft_parentData.gender = h._ft_data.gender),
              (u._ft_childData.mid = c.id),
              (u._ft_childData.fid = h.id),
              (u._ft_parentData.gender = h._ft_data.gender)),
            this.add(f),
            this.add(u);
        } else
        ...
        for (var y = 0; y < l.length; y++)
          (l[y].mid != c.pids[s] && l[y].fid != c.pids[s]) ||
            ((l[y].mid = void 0),
            (l[y].fid = void 0),
            (l[y].stpid = "_ft_child_group_" + s),
            this.add(l[y]));
      }
    this.add(c);
    var g = this;
